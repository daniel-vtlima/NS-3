...
//Definindo os Nós
	...
	r2.SetDeviceAttribute("DataRate", StringValue("100Mbps"));
	r2.SetChannelAttribute("Delay", StringValue("0.2432ms"));
	...
	r3.SetDeviceAttribute("DataRate", StringValue("100Mbps"));
	r3.SetChannelAttribute("Delay", StringValue("0.29502ms"));
...
//R2
	devices = r2.Install(nodes.Get(6), nodes.Get(12));
	address.SetBase("10.1.9.0", "255.255.255.0");	
	interfaces.Add(address.Assign(devices));
    devices = r2.Install(nodes.Get(6), nodes.Get(7));
	address.SetBase("10.1.9.0", "255.255.255.0");	
	interfaces.Add(address.Assign(devices));
//Conexões de G
	...
	interfaces.Add(address.Assign(devices));
//R3
	devices = r3.Install(nodes.Get(10), nodes.Get(13));
	address.SetBase("10.1.12.0", "255.255.255.0");	
	interfaces.Add(address.Assign(devices));	
    devices = r3.Install(nodes.Get(10), nodes.Get(14));
	address.SetBase("10.1.12.0", "255.255.255.0");	
	interfaces.Add(address.Assign(devices));
//Conexões de R6	
